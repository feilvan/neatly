...
If you _really_ like my work you can buy me a coffee to fuel further development.<br>
...
5. Customise everything to your liking. (_optional_)

<sup>1) If you're running into trouble with a restart seemingly not working you can navigate to `about:profiles` and click the »_Restart Normally_«-Button.</sup>
...
[Mozilla's Side View](https://addons.mozilla.org/en-GB/firefox/addon/side-view/) is an Addon that allows you to open a second Website within the Sidebar of your Browser. Cascades integration gets rid of the header, moves the »_Close_«-Button to the bottom, and allows the sidebar to be up to 50% of your browsers width.
